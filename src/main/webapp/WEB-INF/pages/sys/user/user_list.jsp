  ...
  <head>
    ...
    <script type="text/javascript">
       ...
       $(function(){
    	   ...
    	   userTable=$("#user_table").dataTable({
               ...
               /*  "bSort" : true,          //是否可以排序 */
                ...
                "sAjaxSource" : "<%=basePath%>user/getUserList.do", //请求数据的URL
       ...
       function user_role(id){
    	   parent.id=id;
    		var url ="<%=basePath%>user/userRole.do?id="+id;
     ...
     //添加
       ...
       function user_stop(obj, id){
	      layer.confirm('确认要禁用此用户吗？',function(index){
	         var url = "<%=basePath%>user/modifyUserStatus.do";
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="batch_delete()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	 <a href="javascript:;" onclick="user_add('添加图片信息','<%=basePath %>user/addUser.do')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> </div>
	<div class="mt-20">
