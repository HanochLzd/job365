...
<article class="page-container">
	<form method="post" class="form form-horizontal" id="form-positioninfo-add">
	  ...
	  <input name = "op" type="hidden" value="${op}"/>			
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">留言：</label>
			<div class="formControls col-xs-8 col-sm-9"> 
				<!--<textarea id="editor" name="bianjineirong" type="text/plain" >请于此编辑您的资讯信息...</textarea>  positionDesc-->
				<textarea id="editor" type="text/plain" name="positionDesc" style="width:100%;height:300px;">${position.positionDesc}</textarea>
			</div>
		</div>
		<div class="row cl">
