...
<div style="">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 职位管理 <span
            class="c-gray en">&gt;</span> 职位列表 <a class="btn btn-success radius r"
    ...
    <div class="page-container">
        <div class="text-c"> 日期范围：
            ...
            <input type="text" name="positionName" id="positionName" placeholder=" 职位名称" style="width:250px"
                   class="input-text">
            <button name="" id="" class="btn btn-success" onclick="f_getList()"><i class="Hui-iconfont">&#xe665;</i>搜职位
            </button>
        </div>
        <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="batch_delete()"
                                                                    class="btn btn-danger radius"><i
                class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
		<a class="btn btn-primary radius" onclick="position_add('添加职位','<%=basePath %>position/add.do')"
           href="javascript:;">
                ...
                },
                {
                    ...
                    "mRender": function (a, b, c, d) {
                        if (${LONGIN_USER_ROLE == 'admin'}) {
                            ...
                            return '<a title="删除" href="javascript:;" onclick="position_del(this,' + c.id + ')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>&nbsp;&nbsp;&nbsp;&nbsp;'
                                + '<a title="编辑" href="javascript:;" onclick="position_edit(' + c.id + ')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></center>'
                        }
                    }
                },
