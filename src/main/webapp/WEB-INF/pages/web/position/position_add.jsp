...
<article class="page-container">
    <form method="post" class="form form-horizontal" id="form-positioninfo-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${position.positionRequire}" placeholder=""
                       id="positionRequire" name="positionRequire">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">联系电话：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${position.positionPhone}" placeholder=""
                       id="positionPhone" name="positionPhone">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">工作地点：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="${position.positionAddress}" placeholder=""
                       id="positionAddress" name="positionAddress">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <textarea id="editor" type="text/plain" name="positionDesc"
                          style="width:100%;height:500px;">${position.positionDesc}</textarea>
            </div>
        </div>
        <div class="row cl">
