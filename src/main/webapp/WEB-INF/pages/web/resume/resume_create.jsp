...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-resume-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="@" value="${resume.resumePhone}" name="resumePhone" id="resumePhone">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="@" value="${resume.resumeEmail}" name="resumeEmail" id="resumeEmail">
			</div>
		</div>						
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="@" value="${resume.resumeExperience}" name="resumeExperience" id="resumeExperience">
			</div>
		</div>
		<div class="row cl">
