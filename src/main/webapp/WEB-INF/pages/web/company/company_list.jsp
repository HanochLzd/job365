...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> job365后台管理 <span class="c-gray en">&gt;</span> 企业管理<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="请输入公司名称" id="companyName" name="name">
...
<div class="cl pd-5 bg-1 bk-gray mt-20"> 
	<span class="l">
	 ...
	 <a class="btn btn-primary radius" data-title="添加企业"  onclick="company_add()" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加企业</a>
	</span>
...
function companyinfo_shangjia(obj , id){
	layer.confirm('是否发布？',function(index){
		$.post('<%=basePath%>company/shangjia.do',{"id":id}, function(data) {
			var jsonReturn = eval("(" + data +")");
			companyinfoTable.fnDraw(true);
